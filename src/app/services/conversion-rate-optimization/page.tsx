    ...
    <>
      ...
      <div className="pointer-events-none absolute left-1/2 top-0 z-0 h-[420px] w-[420px] -translate-x-1/2 rounded-full bg-blue-900/10 blur-[120px]" aria-hidden />
        <div className="container mx-auto px-6 text-center">
          <p className="text-teal-400/90 text-xs md:text-sm uppercase tracking-[0.35em] mb-4">CRO • Analytics • UX</p>
      ...
      <section className="py-20 md:py-28 bg-zinc-950">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-12">
            <p className="text-teal-400/90 font-semibold uppercase tracking-wide">Where we attack first</p>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {leveragePoints.map((point) => (
              <div key={point.title} className="rounded-sm border border-zinc-800 bg-zinc-950/70 p-6">
                <h3 className="text-xl font-semibold text-white mb-3">{point.title}</h3>
                <p className="text-zinc-500">{point.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 md:py-28 bg-black">
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mb-12">
            <p className="text-teal-400/90 font-semibold uppercase tracking-wide">CRO sprint flow</p>
            <h2 className="text-3xl md:text-4xl font-bold text-white mt-3">Audit. Deploy. Scale.</h2>
          </div>
      ...
      <section className="py-20 md:py-28 bg-zinc-950 text-white">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <p className="text-teal-400/90 font-semibold uppercase tracking-wide">Included in every sprint</p>
            <h2 className="text-3xl md:text-4xl font-bold">Everything required to fix conversion leaks.</h2>
          </div>
      ...
      <section className="py-20 md:py-28 bg-zinc-950 text-white text-center border-t border-zinc-800">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to squeeze more revenue from your current traffic?</h2>
