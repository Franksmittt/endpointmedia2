...
const RoodepoortPage = () => {
  const locationSchema = buildLocationLocalBusinessSchema({
    ...
    latitude: -26.1625,
    longitude: 27.8725,
    wikidataUrl: WIKIDATA.roodepoort,
  });
      ...
      <nav className="border-b border-zinc-800 bg-black py-4" aria-label="Breadcrumb">
        <div className="container mx-auto px-6">
          <ol className="flex items-center space-x-2 text-sm text-zinc-500">
            ...
            <li>/</li>
            <li className="text-white font-semibold">Roodepoort</li>
          </ol>
        </div>
      </nav>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <div className="rounded-sm border border-zinc-800 bg-zinc-950/70 p-6">
                <h3 className="text-xl font-bold mb-2 font-heading text-white">Roodepoort CBD</h3>
                <p className="text-zinc-500 text-sm">
                  Central business district, offices, professional services
                </p>
              </div>
              <div className="rounded-sm border border-zinc-800 bg-zinc-950/70 p-6">
                <h3 className="text-xl font-bold mb-2 font-heading text-white">Roodepoort Mall</h3>
                <p className="text-zinc-500 text-sm">
                  Major shopping center, retail businesses, restaurants
                </p>
              </div>
              <div className="rounded-sm border border-zinc-800 bg-zinc-950/70 p-6">
                <h3 className="text-xl font-bold mb-2 font-heading text-white">Honeydew</h3>
                <p className="text-zinc-500 text-sm">
                  Nearby suburb, commercial area, local businesses
                </p>
              </div>
              <div className="rounded-sm border border-zinc-800 bg-zinc-950/70 p-6">
                <h3 className="text-xl font-bold mb-2 font-heading text-white">Strubensvalley</h3>
                <p className="text-zinc-500 text-sm">
                  Adjacent area, retail, professional services
                </p>
              </div>
              <div className="rounded-sm border border-zinc-800 bg-zinc-950/70 p-6">
                <h3 className="text-xl font-bold mb-2 font-heading text-white">Helderkruin</h3>
                <p className="text-zinc-500 text-sm">
                  Nearby residential and commercial area
                </p>
              </div>
              <div className="rounded-sm border border-zinc-800 bg-zinc-950/70 p-6">
                <h3 className="text-xl font-bold mb-2 font-heading text-white">Wilropark</h3>
                <p className="text-zinc-500 text-sm">
