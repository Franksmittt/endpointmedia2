...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/locations/waterfall",
  },
  openGraph: {
    title: "Web Design Waterfall | Endpoint Media",
    description: "Professional web design and local SEO services for Waterfall businesses.",
