  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 z-10 relative text-center flex flex-col justify-center h-full">
        <h1
          id="hero-headline"
          className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight mb-4 md:mb-6 text-white"
        >
        ...
        <p
          id="hero-summary"
          className="text-base sm:text-lg md:text-xl lg:text-2xl max-w-4xl mx-auto text-zinc-400 mb-4 md:mb-6"
        >
        ...
        <p
          className="text-sm sm:text-base md:text-lg max-w-3xl mx-auto text-zinc-400 mb-6 md:mb-8 animate-fade-in-up"
        ...
        <div className="animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
          <a
            href="#audit"
            className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-teal-600 to-teal-500 hover:from-teal-500 hover:to-teal-400 text-white font-bold py-3 px-8 md:py-4 md:px-12 rounded-lg shadow-2xl shadow-teal-500/30 border-2 border-teal-400/50 transform hover:scale-105 transition-all duration-300 ease-in-out uppercase text-sm md:text-base tracking-wider focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-charcoal focus-visible:ring-teal-300"
          >
