  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 z-10 relative text-center flex flex-col justify-center h-full">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold leading-tight mb-4 md:mb-6 animate-fade-in-up text-white">
        ...
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl max-w-4xl mx-auto text-gray-200 mb-4 md:mb-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
        ...
        <p className="text-sm sm:text-base md:text-lg max-w-3xl mx-auto text-gray-300 mb-6 md:mb-8 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
        ...
        <div className="mt-3 md:mt-4 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
          <a
            ...
            className="inline-flex items-center justify-center gap-2 text-cyan-400 hover:text-cyan-300 font-semibold transition-colors text-sm md:text-base"
          >
