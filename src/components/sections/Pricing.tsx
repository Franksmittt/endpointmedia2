  ...
  return (
    <section id="pricing" data-chunk-boundary="true" className="bg-zinc-950 py-20 md:py-28">
      <div className="container mx-auto px-6">
        ...
        <table
          className="mt-16 grid items-stretch gap-6 md:mt-20 md:gap-8 lg:grid-cols-3"
          aria-label="Website architecture pricing packages"
        >
          <caption className="sr-only">Website architecture pricing packages</caption>
