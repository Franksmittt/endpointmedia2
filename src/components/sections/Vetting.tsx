      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <header className="text-center mb-10">
            ...
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-4 font-heading text-cyan-400 bg-gradient-to-r from-cyan-400 via-white to-cyan-400 bg-clip-text text-transparent">
          ...
          <div className="grid md:grid-cols-3 gap-10 text-center divide-y md:divide-y-0 md:divide-x divide-cyan-500/20">
            ...
            <div className="p-4 pt-8 md:pt-4 group">
              <div className="w-16 h-16 mx-auto mb-4 text-cyan-400 group-hover:text-teal-400/90 transition-colors relative">
              ...
              <h3 className="text-xl font-bold font-heading mb-1 text-white group-hover:text-teal-400/90 transition-colors">Hyper-Local Focus</h3>
            ...
            <div className="p-4 pt-8 md:pt-4 group">
              ...
              <h3 className="text-xl font-bold font-heading mb-1 text-white group-hover:text-teal-400/90 transition-colors">Mastery Driven</h3>
              <p className="text-zinc-400">
            ...
            <div className="p-4 pt-8 md:pt-4 group">
              ...
              <h3 className="text-xl font-bold font-heading mb-1 text-white group-hover:text-teal-400/90 transition-colors">Growth Mindset</h3>
              <p className="text-zinc-400">
